...
//separo p desenhar cada molecula de cada lado
...
//a aleatoriedade vem de ser possivel o valor -1, 0 ou +1
  const random = SPEED * (getRandomInt(3) - 1);
  position += random;
//nao posso passar do limite da tela
